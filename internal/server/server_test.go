...
func setupTest(t *testing.T, fn func(*Config)) (
	...
	// NOTE: Announces on local address
	...
	// NOTE: initialize an instance of log using our library
	...
	// NOTE: create our server with the instance of our log
	server, err := NewGRPCServer(cfg, grpc.Creds(serverCreds))
	require.NoError(t, err)

	// NOTE: spin up a thread to run our server
	go func() {
		server.Serve(l)
	}()
